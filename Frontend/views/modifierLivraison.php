			...
			<div class="row">
				<div class="col-md-6 p-b-30">
					<div class="p-r-20 p-r-0-lg">
						<iframe src="https://giphy.com/embed/l1BgSKQQgjBO80I5q" width="480" height="480" frameBorder="0" class="giphy-embed" allowFullScreen></iframe><p><a href="https://giphy.com/gifs/illustration-sun-character-l1BgSKQQgjBO80I5q"></a></p>
					</div>
				</div>
				...
				<div class="col-md-6 p-b-30">
					<form class="leave-comment" method="POST">
						...
						<div class="bo4 of-hidden size15 m-b-20">
							<input id="name" class="sizefull s-text7 p-l-22 p-r-22" type="text" name="nom" value="<?PHP echo $nom ?>" >
						</div>

						<div class="bo4 of-hidden size15 m-b-20">
							<input id="fname" class="sizefull s-text7 p-l-22 p-r-22" type="text" name="prenom" value="<?PHP echo $prenom ?>" >
						</div>

						<div class="bo4 of-hidden size15 m-b-20">
							<input  class="sizefull s-text7 p-l-22 p-r-22" type="number" name="cin" value="<?PHP echo $cin ?>" >
						</div>	

						<div class="bo4 of-hidden size15 m-b-20">
							<input id="num" class="sizefull s-text7 p-l-22 p-r-22" type="number" name="numero" value="<?PHP echo $numero ?>" >
						</div>

					

						<div class="bo4 of-hidden size15 m-b-20">
							<input  class="sizefull s-text7 p-l-22 p-r-22" type="mail" name="email" value="<?PHP echo $email ?>" >
						</div>
