...
$listeEvennements=$evennement1C->afficherEvennements();
...
<html>
    ...
    <head>
        <title>Afficher Evennement</title>
        <!-- Bootstrap -->
                            ...
                            <div class="navbar">
                                <div class="navbar-inner">
                                    <ul class="breadcrumb">
                                        ...
                                        <li>
                                            <a href="#">Evennement</a> <span class="divider">/</span>    
                                        </li>
                                        <li>
                                            <a href="livraison.html" >Afficher Evennement</a> <span class="divider">/</span><li class="active"></li> 
                                        </li>
                                    </ul>
                                </div>
                            </div>
...
foreach($listeEvennements as $row){
    ...
    <td><a href="modifierEvennement.php?nom=<?PHP echo $row['nom']; ?>" class="btn btn-primary">
    Modifier</a></td>
    </tr>
    <?PHP
}
