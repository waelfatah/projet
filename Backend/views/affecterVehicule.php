...
$sql="SELECT matricule from vehicule ";
                            ...
                            <div class="navbar">
                                <div class="navbar-inner">
                                    <ul class="breadcrumb">
                                        ...
                                        <li>
                                            <a href="afficherLivraison.php" >Afficher Livraison</a> <span class="divider">/</span><li class="active"></li> 
                                        </li>
                                    </ul>
                                </div>
                            </div>
...
<tbody>
    ...
    <td><select name="vehicule">
            <option><?PHP echo $row['vehicule']; ?></option>
                <?php
                    foreach ($results as $output) { ?>
                        <option value="<?php echo $output["matricule"] ?>" > <?php echo $output["matricule"] ?></option>
...
if (isset($_POST['modifier'])){
    $etat='Present';
    $chauffeur=new chauffeur($nom,$prenom,$cin,$numero,$email,$etat,$recc,$_POST['vehicule']) ;
