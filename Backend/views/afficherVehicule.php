...
$listeVehicules=$vehicule1C->afficherVehicules();
                            ...
                            <div class="navbar">
                                <div class="navbar-inner">
                                    <ul class="breadcrumb">
                                        ...
                                        <li>
                                            <a href="livraison.html" >Afficher Vehicules</a> <span class="divider">/</span><li class="active"></li> 
                                        </li>
                                    </ul>
                                </div>
                            </div>
                        ...
                        <div class="span6">
                            ...
                            <div class="block">
                                <div class="navbar navbar-inner block-header">
                                    <div class="muted pull-left">Vehicules</div>
...
<?PHP
foreach($listeVehicules as $row){
    ?>
    <tr>
    
    <td><?PHP echo $row['matricule']; ?></td>
    <td><?PHP echo $row['genre']; ?></td>
    <td><form method="POST" action="supprimerVehicule.php">
    ...
    <td><a href="modifierVehicule.php?matricule=<?PHP echo $row['matricule']; ?>" class="btn btn-primary">Modifier</a></td>
    </tr>
    <?PHP
}
?>
