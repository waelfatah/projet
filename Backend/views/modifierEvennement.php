...
if (isset($_GET['nom'])){
    ...
    $result=$evennementC->recupererEvennement($_GET['nom']);
            ...
            <div class="row-fluid">
                <div class="span3" id="sidebar">
                    <ul class="nav nav-list bs-docs-sidenav nav-collapse collapse">
                        ...
                        <li class="active">
                            <a href="evenement.html"><span class="badge badge-success pull-right">2</span> Evennements</a>
                        </li>
                            <li class="dropdown">
                                    ...
                                    <form class="form-horizontal" method="POST">
                                      <fieldset>
                                        ...
                                        <div class="control-group">
                                          ...
                                          <div class="controls">
                                            <input name="nom" type="text" class="span6" id="typeahead"  data-provide="typeahead" data-items="4" value="<?PHP echo $nom ?>">
                                        ...
                                        <div class="control-group">
                                          ...
                                          <div class="controls">
                                            <input name="date_deb" type="text" class="input-xlarge datepicker" id="date01" placeholder="Cliquer pour Calendrier" value="<?PHP echo $date_deb ?>">
                                        ...
                                        <div class="control-group">
                                          ...
                                          <div class="controls">
                                            <input name="description" type="text" class="span6" id="typeahead"  data-provide="typeahead" data-items="4" value="<?PHP echo $description ?>">
...
if (isset($_POST['modifier'])){
    $evennement=new evennement($_POST['nom'],$_POST['date_deb'],$_POST['periode'],$_POST['boutiques'],$_POST['description']);
    $evennementC->modifierEvennement($evennement,$_POST['nom_ini']);
    //echo $_POST['cin_ini'];
