...
<iframe src="https://giphy.com/embed/l1BgSKQQgjBO80I5q" width="480" height="480" frameBorder="0" class="giphy-embed" allowFullScreen></iframe>
					</div>
				</div>

				<div class="col-md-8 p-b-30">
					<h3 class="m-text26 p-t-15 p-b-16">
						<?PHP $identite = $prenom." ".$nom; echo $identite  ?>
					</h3>
					<br><br>
					<div class="bo13 p-l-29 m-l-9 p-b-10">
							<label><th class="column-1">CIN : </th> <?PHP echo $cin ?></label>
							<br><br>
							<label><th class="column-1">NUMERO : </th> <?PHP echo $numero ?></label>
							<br><br>
							<label><th class="column-1">E-MAIL : </th> <?PHP echo $email ?></label>
							<br><br>
							<label><th class="column-1">AVIS SUR LE LIVREUR : </th> <?PHP if (empty($recc)) {
								echo "Aucun avis sur ce livreur";
							} else { echo $recc; }?></label>
							<br><br>
							<label><th class="column-1">VEHICULE : </th> <?PHP echo $vehicule ?></label>
...
<a href="afficherLivraison.php" class="flex-c-m size1 bg1 bo-rad-20 hov1 s-text1 trans-0-4">
										Retouner Vers La Livraison
									</a>
		</div>
	</section>
