...
function sendConfirmationLivraison($destinataire)
{
...
try {
    ...
    $mail->Subject = 'Etat Livraisons';
    $mail->Body    = '<b>Votre Livraison a ete ajoutee </b>';
    $mail->AltBody = 'Votre Livraison a ete ajoutee';
