          	...
          	<?php foreach ($products as $product): ?>
                <div class="block2-img wrap-pic-w of-hidden pos-relative">
                  ...
                  <div class="block2-overlay trans-0-4">
                    <a href="addwishlist.php?id=<?= $product->id;?>"class="addPanier block2-btn-addwishlist hov-pointer trans-0-4">
                      <i class="addPanier icon-wishlist icon_heart_alt" href="addwishlist.php?id=<?= $product->id;?>" aria-hidden="true"></i>
                      <i class="addPanier icon-wishlist icon_heart dis-none" 
                      href="addwishlist.php?id=<?= $product->id;?>"aria-hidden="true"></i>
                    </a>
                    ...
                    <div class="block2-btn-addcart w-size1 trans-0-4">
                      ...
                      <a   class="addPanier flex-c-m size1 bg4 bo-rad-23 hov1 s-text1 trans-0-4" name "addPaniers"  href="addpanier.php?id=<?= $product->id;?>" >Add to Cart</a>
