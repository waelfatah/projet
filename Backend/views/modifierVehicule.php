                                ...
                                <div class="span12">
                                    ...
                                    <fieldset>
                                       ...
                                       <div class="control-group">
                                          ...
                                          <div class="controls">
                                            <input type="text" class="span6" name="matricule"  data-provide="typeahead" data-items="4" value="<?PHP echo $matricule ?>">
                                        ...
                                        <div class="control-group">
                                          ...
                                          <div class="controls">
                                            <select id="select01" name="genre" class="chzn-select">
                                        ...
                                        <div class="form-actions">
                                          ...
                                          <input type="hidden" name="matricule_ini" value="<?PHP echo $_GET['matricule'];?>">
        ...
        $(function() {
            ...
            $('#rootwizard').bootstrapWizard({onTabShow: function(tab, navigation, index) {
                ...
                if($current >= $total) {
                    ...
                    $('#rootwizard').find('.pagear .next').show();
...
if (isset($_POST['modifier'])){
    $vehicule=new vehicule($_POST['matricule'],$_POST['genre']);
    $vehiculeC->modifierVehicule($vehicule,$_POST['matricule_ini']);
    //echo $_POST['cin_ini'];
